...
// Dynamic prompting example with Top-P sampling
...
const topP = 0.8;  // You can adjust Top-P value here
dynamicPrompt(basePrompt, tone, detailLevel, topP).then((dynamicResponse) => {
    console.log('Dynamic Prompt Response with Top-P:', dynamicResponse);
});
